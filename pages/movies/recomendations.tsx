...
const MoviesReco: NextPage<MoviesRecoProps> = () => {
  const {
    dispatch,
  ...
  const getInitialData = async () => {
    const recomendationsData = await getInitialRecomendations(dispatch, 'movie', 0, 'AR')
