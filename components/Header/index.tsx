...
const Header = () => {
  ...
  return (
    <header className="max-w-[1000px] w-full flex md:px-4 md:pt-3 pb-4 z-10 md:fixed left-0 right-0 top-0 bg-main-bg mx-auto">
      <div className="flex items-center justify-center mt-10 md:mt-0 w-36 mx-auto md:mx-0 md:mr-6">
      ...
      <div className="md:hidden z-20 fle justify-center fixed w-full bottom-0 bg-main-bg">
        <div className="flex w-full flex-1">
          {LINKS.map((link) => {
            return (
              ...
              >
                <div className="items-center h-16 flex font-semibold justify-center w-full">
                  <Link
