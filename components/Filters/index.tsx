  ...
  return (
    <Box  margin="30px 0 0">
      ...
      <Box width="100%" display="flex" justifyContent="center" marginTop="10px">
        {providers?.length ? (
          <>
            <Box onClick={() => handleFilter(0)} className={allFilters}>
            ...
            {providers.map((prov: any) => {
              ...
              return (
                <Box key={prov.provider_id} onClick={() => handleFilter(prov.provider_id)} className={filtersClasses}>
