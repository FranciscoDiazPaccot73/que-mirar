...
const Card: FC<CardProps> = ({ source, nextRecomendation, search }) => {
  ...
  const cardClasses = classNames(
    'w-full overflow-hidden flex min-h-[400px] border-y border-purple-50 mt-3 py-3 md:py-0 md:mt-0 md:min-h-[500px] md:rounded md:rounded-md md:border md:border-purple-50',
    {
